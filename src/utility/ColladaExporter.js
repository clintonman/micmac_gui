...
const ColladaExporter = function () {};
...
console.log("tex", tex)
			...
			if ( texid == null ) {
				...
				if ( version === '1.5.0' ) {
					...
					//use actual file that will be copied to dae folder
					// imageNode += `<init_from>${ options.textureDirectory }${ name }.${ ext }</init_from>`;
					imageNode += `<init_from>${ options.textureDirectory }${ path.basename(tex.image.currentSrc) }</init_from>`;
...
export default ColladaExporter;